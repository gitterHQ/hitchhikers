...
var db = require('../db');
var repoLeaderboard = require('../db/repo-leaderboard');
var repoLangLeaderboard = require('../db/repo-lang-leaderboard');
...
router.get('/repo-languages', function(req, res, next) {
  return repoLangLeaderboard()
    .then(function(results) {
      res.send(results);
    })
    .catch(next);
