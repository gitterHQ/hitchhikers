...
var PUBLIC_FIELDS = exports.PUBLIC_FIELDS = [
  'login', 'name', 'lat', 'lon', 'city', 'country', 'distance'
];

var USER_ATTRIBUTES = exports.USER_ATTRIBUTES = [
  'name', 'login', 'email', 'lat', 'lon', 'city', 'country', 'partial'
];
...
var prefill = exports.prefill = function(user) {
  ...
  if (user.lat && user.lon) {
    user.distance = geolib.getDistance(
      ...
      {latitude: process.env.VENUE_LAT, longitude: process.env.VANUE_LON}
    );
  }
};
